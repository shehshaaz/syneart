...
export default function ProductList({ limit, showHeader = true }) {
    ...
    return (
        <section id="rooms" className="mt-16">
            {showHeader && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12" data-aos="fade-up">
                    <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {displayedProducts.length > 0 ? displayedProducts.map((product) => (
                    <div key={product._id} className="group" data-aos="fade-up" data-aos-delay="100">
